...
class TestHBNBCommand_exit(unittest.TestCase):
    """Test for exiting from the HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Test for show from the HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Test for destroy from the HBNB command interpreter."""
